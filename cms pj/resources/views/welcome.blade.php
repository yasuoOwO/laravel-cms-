...
<div class="banner_section layout_padding">
    <div id="main_slider" class="carousel slide" data-ride="carousel">
       ...
       <i class="fa fa-left"><img src="{{url('assets/images/left-icon.png')}}"></i>
       </a>
       <a class="carousel-control-next" href="#main_slider" role="button" data-slide="next">
       <i class="fa fa-right"><img src="{{url('assets/images/right-icon.png')}}"></i>
       </a>
    </div>
 </div>
 <!-- banner section end -->
       ...
       <div class="container-fluid padding_0">
          <div class="box_main">
             <div class="box_left">
                <div class="box_left_main">
                   ...
                   <div class="box_right_one">
                      <div class="icon_1"><img src="{{url('assets/images/icon-1.png')}}"><span class="padding_left_10">architecture  Design</span></div>
             ...
             <div class="box_middle">
                <div class="box_left_main">
                   <div class="padding_10">
                      <div class="icon_1"><img src="{{url('assets/images/icon-2.png')}}"><span class="padding_left_10">architecture  Design</span></div>
                      <p class="long_text">It is a long established fact that a reader will be distracted by the </p>
                   </div>
                </div>
                <div class="see_bt"><a href="#">See More</a></div>
             ...
             <div class="box_right">
                <div class="box_left_main">
                   <div class="box_right_one">
                      <div class="icon_1"><img src="{{url('assets/images/icon-3.png')}}"><span class="padding_left_10">architecture  Design</span></div>
                      <p class="long_text">It is a long established fact that a reader will be distracted by the </p>
                   </div>
                   <div class="box_left_one">
    ...
    <div class="philosophy_section_2 layout_padding">
       <div class="container-fluid">
          <div class="row">
             ...
             <div class="col-md-6 padding_0">
                <div class="image_7"><img src="{{url('assets/images/img-7.png')}}"></div>
             </div>
          </div>
       </div>
    </div>
                ...
                <div class="client_section_2 layout_padding">
                   <div class="client_main">
                      <div class="client_left">
                         <div class="client_img"><img src="{{url('assets/images/client-img.png')}}"></div>
